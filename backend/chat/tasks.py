...
from .models import ChatRoom, UserMessageStatus, Message
...
def update_unread_counts(room_name, sender_id):
    try:
        ...
        for entry in unread_counts:
            ...
            async_to_sync(cache_utility.set)(cache_key, entry["unread_count"], timeout=3600)
...
def send_notification_to_group(room_name, message_id):
    try:
        ...
        async_to_sync(cache_utility.publish)(f'notification_channel_{room_name}', notification_json)

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(default='Client', max_length=50, verbose_name='User Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listed', models.BooleanField(default=False, help_text='Indicates whether the coach is approved by the admin', verbose_name='Listed')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('certification_title', models.CharField(max_length=255, verbose_name='Certification Title')),
                ('certification_detail', models.CharField(max_length=255, verbose_name='Certification Detail')),
                ('coach', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='certifications', to='users.coachprofile')),
            ],
            options={
